...
/**
 * A feature flag for a project or an issue.
 *
 * @param request - function to call the graphql client
...
export declare class FeatureFlag extends Request {
    ...
    get integration(): LinearFetch<Integration> | undefined;
    /** The issue the feature flag is associated with. */
    get issue(): LinearFetch<Issue> | undefined;
...
export declare class NotificationCategoryPreferences extends Request {
    ...
    appsAndIntegrations?: NotificationCategoryPreferencesChannel;
    /** The preferences for notifications about assignments. */
    assignments?: NotificationCategoryPreferencesChannel;
    /** The preferences for notifications about comments and replies. */
    commentsAndReplies?: NotificationCategoryPreferencesChannel;
    /** The preferences for notifications about document changes. */
    documentChanges?: NotificationCategoryPreferencesChannel;
    /** The preferences for notifications about mentions. */
    mentions?: NotificationCategoryPreferencesChannel;
    /** The preferences for notifications about posts and updates. */
    postsAndUpdates?: NotificationCategoryPreferencesChannel;
    /** The preferences for notifications about reactions. */
    reactions?: NotificationCategoryPreferencesChannel;
    /** The preferences for notifications about reminders. */
    reminders?: NotificationCategoryPreferencesChannel;
    /** The preferences for notifications about reviews. */
    reviews?: NotificationCategoryPreferencesChannel;
    /** The preferences for notifications about status changes. */
    statusChanges?: NotificationCategoryPreferencesChannel;
    /** The preferences for notifications about subscriptions. */
    subscriptions?: NotificationCategoryPreferencesChannel;
}
/**
 ...
 */
export declare class NotificationCategoryPreferencesChannel extends Request {
    constructor(request: LinearRequest, data: L.NotificationCategoryPreferencesChannelFragment);
 ...
 *
 * @param request - function to call the graphql client
 * @param data - L.PullRequestCommentFragment response data
 */
export declare class PullRequestComment extends Request {
    constructor(request: LinearRequest, data: L.PullRequestCommentFragment);
    /** The time at which the entity was archived. Null if the entity has not been archived. */
    archivedAt?: Date;
    /** The time at which the entity was created. */
    createdAt: Date;
 ...
 */
export declare class WebhookFailureEventConnection extends Connection<WebhookFailureEvent> {
    constructor(request: LinearRequest, fetch: (connection?: LinearConnectionVariables) => LinearFetch<LinearConnection<WebhookFailureEvent> | undefined>, data: L.WebhookFailureEventConnectionFragment);
}
/**
 ...
 */
export declare class Comment_InitiativeUpdateQuery extends Request {
    private _variables?;
    constructor(request: LinearRequest, variables?: L.Comment_InitiativeUpdateQueryVariables);
    /**
     ...
     */
    fetch(variables?: L.Comment_InitiativeUpdateQueryVariables): LinearFetch<InitiativeUpdate | undefined>;
}
/**
...
export declare class UserSettings_NotificationCategoryPreferences_AppsAndIntegrationsQuery extends Request {
     ...
     */
    fetch(): LinearFetch<NotificationCategoryPreferencesChannel | undefined>;
}
/**
